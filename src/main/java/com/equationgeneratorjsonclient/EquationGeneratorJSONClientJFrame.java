   ...
   {//GEN-HEADEREND:event_generateJButtonActionPerformed
      try
      {
         ...
         String url = String.format( "http://localhost:8080/" +
            "EquationGenerator-1.0-SNAPSHOT/EquationGeneratorJSON/equation/%s/%d",
         ...
         Equation equation =
            new ObjectMapper().disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES).readValue( reader, Equation.class );
